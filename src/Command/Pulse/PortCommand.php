...
use App\Service\RangeRandomizer;
...
class PortCommand extends Command
{
    ...
    public function __construct(RangeRandomizer $rr, Updater $updater)
    {
        $this->rr = $rr;
    ...
    {
        $this->setName('orchestrator:pulse:port')
...
/*
        ...
        echo $count;
*/
        $executor->execute(sprintf('nmap -p %s-%s www.nu.nl -oN /home/jkr/projects/orchestrator/scans/nmap/20180807-www.nu.nl.txt', $ranges[1]['min'], $ranges[1]['max']),3600);
